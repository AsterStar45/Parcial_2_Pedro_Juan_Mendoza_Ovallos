...
def verificar_division(operacion,num2):
    if operacion == "division" and num2 == 0:
        messagebox.showerror("Error", "División por cero no permitida.")
    elif operacion == "potencia" and num2 == 0:
        messagebox.showinfo("Dato","Todo número elevado a 0 da 1.")
...
def realizar_operacion(operacion):
    try:
        ...
        if operacion == "suma":
            ...
            verificar_division(operacion,num2)              
            resultado = num1 ** num2
...
boton_division = Button(root, text="Potencia", command=lambda: realizar_operacion("potencia"))
boton_division.pack()
